...
class TableViewController: NSViewController, BaseViewController {
    ...
    func loadData() {
        page += 1
        isLoading = true
        makeRequest(page: page, limit: limit) { (success, totalCount, data, error) in
    ...
    func makeRequest(page: Int, limit: Int, completion: @escaping (_ success: Bool, _ totalCount: Int?, _ data: [Model]?, _ error: Error?) -> Void) {
